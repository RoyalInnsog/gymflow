...
module.exports = {
  escapeLike, isValidDate, toInteger, toNumeric, whitelist,
  authorize, requireFeature, getTaxConfig, computeTax, resolveRenewalDiscount, uid, nextInvoiceNumber, checkSubscription,
  logActivity, resolveTemplate
};
